        ...
        <section class="modal-card-body">
          ...
          <div class="columns is-multiline">
            <div class="column is-half">
              <div v-if="isMetaMaskInstalled" class="provider has-radius" @click="selectWallet('metamask')">
            ...
            <div class="column is-half">
              ...
              <a v-else class="provider has-radius" href="https://docs.binance.org/smart-chain/wallet/binance.html"
                 target="_blank">
                <img src="@/assets/img/providers/bsc.svg">
                Install BSC Wallet
              </a>
...
export default {
  ...
  computed: {
    ...
    isBinanceInstalled() {
      return Boolean(this.$bsc.binance)
    },
  },
  methods: {
